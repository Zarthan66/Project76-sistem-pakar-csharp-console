...
Console.WriteLine(" 53.Sering buang air di malam hari");
Console.WriteLine(" 54.Vagina kering");
...
{
    Console.Write("Penyakit tidak dapat teridentifikasi berdasarkan data yang ada");
